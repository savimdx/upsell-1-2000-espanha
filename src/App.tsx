          ...
          <div className="max-w-2xl w-full bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-2xl relative z-10 text-center space-y-8">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 text-left space-y-4">
              <p className="text-xs font-bold text-slate-500 uppercase tracking-widest border-b border-slate-200 pb-2.5 flex items-center justify-between">
                ...
                <span className="text-orange-600 font-mono text-[10px]">CÓD: RFEF-77291B</span>
              </p>
              <ul className="space-y-3 text-xs sm:text-sm">
                <li className="flex justify-between items-center text-slate-800">
                  ...
                  <span className="font-bold font-mono text-slate-600 whitespace-nowrap">US$ 6,90</span>
                </li>
                ...
                {viewMode === 'thankyou_accepted' ? (
                  <li className="flex justify-between items-center text-amber-900 bg-amber-500/10 border border-amber-500/30 p-2.5 rounded-xl">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-slate-900">Pack 3 en 1: Pase y Control + Juego de Posición + Físicos con Balón</span>
                    </div>
                    <span className="font-black font-mono text-orange-600 whitespace-nowrap">12,48 €</span>
                  </li>
                ) : (
                  <li className="flex justify-between items-center text-slate-400 italic p-1 border-t border-slate-200 pt-2.5">
                    <div className="flex items-center gap-2">
                      <span className="text-slate-400">✕</span>
                      <span>Pack 3 en 1: Pase y Control + Juego de Posición + Físicos con Balón</span>
                    </div>
              ...
              <div className="border-t border-slate-200 pt-3 flex justify-between items-center font-bold text-slate-900 text-sm sm:text-base">
                ...
                <span className="font-mono text-orange-600 text-lg sm:text-xl whitespace-nowrap">
                  {viewMode === 'thankyou_accepted' ? 'US$ 18,80' : 'US$ 6,90'}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                {viewMode === 'thankyou_accepted' && (
                  <button 
                    onClick={() => alert("Simulación de Descarga: El Pack 3 en 1 se ha descargado correctamente.")}
                    className="px-6 py-3 rounded-xl bg-gradient-to-r from-orange-600 to-amber-500 hover:brightness-110 text-white font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg animate-pulse"
                  >
                    <Download className="h-4 w-4" />
                    <span>Descargar Pack 3 en 1</span>
                  </button>
                )}
              </div>
            </div>
